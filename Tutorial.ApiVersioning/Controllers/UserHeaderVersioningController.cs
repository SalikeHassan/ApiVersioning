...
namespace Tutorial.ApiVersioning.Controllers
{
    ...
    [Route("userdetail")]
    [ApiController]
    public class UserHeaderV1VersioningController : ControllerBase
    {
        private readonly IList<User> users;
        public UserHeaderV1VersioningController()
        {
            users = new List<User>();
    ...
    [Route("userdetail")]
    [ApiController]
    public class UserHeaderV2VersioningController : ControllerBase
    {
        private readonly IList<User> users;
        public UserHeaderV2VersioningController()
        {
            users = new List<User>();
            users.Add(new User() { Id = 1, FullName = "Test1 User", Gender = "Male", IsActive = true });
            users.Add(new User() { Id = 2, FullName = "Test2 User", Gender = "Female", IsActive = true });
